...
Route::prefix('admin/medics')->middleware(['auth'])->group(function () {
    ...
    Route::get('/archived', [App\Http\Controllers\Admin\MedicController::class, 'archived'])->name('admin.medics.archived');
    ...
    Route::post('/{id}/archive', [App\Http\Controllers\Admin\MedicController::class, 'archive'])->name('admin.medics.archive');
    Route::post('/{id}/restore', [App\Http\Controllers\Admin\MedicController::class, 'restore'])->name('admin.medics.restore');
});
