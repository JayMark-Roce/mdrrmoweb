# Notification Bell - Installation Instructions

This document explains how to add the notification bell functionality to any admin page without using `@extends` or `@include`.

## Quick Reference

The complete code is available in: `resources/views/admin/partials/notification-bell-snippet.blade.php`

## Step-by-Step Installation

### 1. Add CSS Styles

Add this CSS to your `<style>` section (before `</style>`):
...
### 2. Add Supabase Script (if not already present)
...
### 4. Add JavaScript (in your `<script>` section)
...
✅ `resources/views/admin/reports/reported-cases.blade.php`
✅ `resources/views/admin/reports/index.blade.php`

## Pages That May Need This

- `resources/views/admin/gps/index.blade.php`
- `resources/views/admin/drivers/users.blade.php`
- `resources/views/admin/drivers/index.blade.php`
- `resources/views/admin/medics/index.blade.php`
- `resources/views/admin/pairing/index.blade.php`
- And other admin pages as needed

## Notes

- The notification bell uses a shared Supabase client instance (`window.supabaseClient`) to avoid multiple connections
- The bell appears in the bottom-right corner of the page
- Notifications are triggered when new reports are inserted into the database
- Clicking "Mark read" clears the badge and stops the notification sound
