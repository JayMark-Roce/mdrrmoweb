                ...
                <tbody>
                    ...
                    <tr data-id="{{ $case->id }}" data-user-id="{{ $case->user_id }}">
                        ...
                        @php
                            ...
                            // Determine status color (PHP 7 compatible)
                            $statusColors = [
                                'PENDING' => '#d97706',
                                'ACKNOWLEDGED' => '#2563eb',
                                'ON_GOING' => '#ca8a04',
                            ...
                            $statusColor = $statusColors[$case->status ?? 'PENDING'] ?? '#64748b';
                        @endphp
                        ...
                        <td class="actions">
                            ...
                            <button class="btn-details">
                                <a href="{{ url('/admin/gps') }}?lat={{ $case->latitude }}&lng={{ $case->longitude }}&location={{ urlencode($case->location) }}&caller_name={{ urlencode($case->reporter_name) }}&caller_contact={{ urlencode($case->contact_number ?? '') }}" 
                                class="btn-icon" 
